...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body >
        <div class="forflex">
            <div class="theimage">
                <img src={{url('/imgs/first-img.png')}} width="100px" class="firstimage"  alt="">  
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="just-input">
                                            <input id="email" type="email" placeholder="Username or Email"   class="register-form @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="email"><br>
                                        </div>
                                    ...
                                    <div>
                                         ...
                                         <div class="forhrdiv"><span class="forhr"></span>OR <span class="forhr"></span> </div>
                                         <div>
                                            @error('email')
